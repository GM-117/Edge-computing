...
def main():
    ...
    #
    #             # Sample solutions
    #             positions, reward, cpu_sum, io_sum, bandwidth_sum, memory_sum, task_priority_sum, ns_prob = \
    #                 sess.run(
    #                     [actor.positions, actor.reward, actor.cpu_sum, actor.io_sum, actor.bandwidth_sum,
    #                      actor.memory_sum, actor.task_priority_sum, actor.ns_prob],
    #                     feed_dict=feed)
    #
    #             # Find best solution
    #             j = np.argmin(reward)
